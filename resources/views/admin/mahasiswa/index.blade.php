            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="{{route('mahasiswa')}}" class="has-arrow waves-effect">
                                <i class="bx bx-layout"></i>
                                <span key="t-layouts">Mahasiswa</span>
                            </a>
                        ...
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <button type="button" class="mb-sm-0 btn btn-info waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center">Add New Data</button>
