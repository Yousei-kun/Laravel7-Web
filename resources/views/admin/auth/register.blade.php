...
<!-- Mirrored from themesbrand.com/skote-django/layouts/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Jul 2021 15:31:22 GMT -->
<head>
            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="p-2">
                            <form class="needs-validation" method="post" action="{{ route('register-input') }}">
                                @csrf
{{--                                <div class="mb-3">--}}
